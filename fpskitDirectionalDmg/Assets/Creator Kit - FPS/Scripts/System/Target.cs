...
public class Target : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.DrawRay(transform.position, transform.forward * 2f, Color.blue, 100f);
    }
    ...
    public void Got(float damage, Vector3 hitPosition)
    {
        ...
        if (dotProduct > 0)
        {
            Debug.Log("BLOCKED! Hit sheild from front");
        ...
        Debug.Log("Weak Point! Hit from behind for " + damage + "damage.");
